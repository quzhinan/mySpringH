...
public class FilesIOUtil {
	...
	// 用spring框架的方法 文件下载
	public static ResponseEntity<byte[]> downloadFilesBySpring(HttpServletResponse response, String filePath)
			throws IOException {
		String fileName = filePath.substring(filePath.lastIndexOf(File.separator) + 1);
	...
	// 多文件上传
	public static void uploadMultiFiles(Map<String, MultipartFile> fileMap, String savePath)
	...
	// 多文件上传
	public static void uploadMultiFiles(List<MultipartFile> fileList, String savePath)
			throws IllegalStateException, IOException {
